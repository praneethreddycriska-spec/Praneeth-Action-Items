    ...
    <AnimatePresence>
      ...
      >
        ...
        <button
          ...
          className="mt-4 w-full rounded-xl bg-gradient-to-br from-violet-500 to-fuchsia-500 py-2.5 text-sm font-semibold text-white shadow-md disabled:opacity-50"
        >
